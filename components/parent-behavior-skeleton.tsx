    ...
    <div className="space-y-6 animate-fade-in-up px-2 sm:px-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4">
        ...
        <div className="border-0 bg-linear-to-br from-emerald-50 to-white dark:from-emerald-950/30 dark:to-slate-800/80 shadow-lg overflow-hidden relative group rounded-lg">
          ...
          <div className="p-2.5 sm:p-4 flex items-start justify-between relative z-10 gap-2">
            <div className="flex-1 min-w-0">
              <div className="h-2.5 bg-emerald-300 dark:bg-emerald-600 rounded w-20 mb-1 animate-pulse" />
              <div className="h-6 sm:h-8 bg-emerald-300 dark:bg-emerald-600 rounded w-12 mb-1 animate-pulse" />
              <div className="h-2 sm:h-2.5 bg-emerald-300 dark:bg-emerald-600 rounded w-24 animate-pulse" />
            </div>
        ...
        {/* Total Achievements */}
        <div className="border-0 bg-linear-to-br from-blue-50 to-white dark:from-blue-950/30 dark:to-slate-800/80 shadow-lg overflow-hidden relative group rounded-lg">
          <div className="absolute top-0 right-0 w-20 h-20 bg-blue-500/15 dark:bg-blue-400/10 rounded-full -mr-8 -mt-8" />
          <div className="p-2.5 sm:p-4 flex items-start justify-between relative z-10 gap-2">
            <div className="flex-1 min-w-0">
              <div className="h-2.5 bg-blue-300 dark:bg-blue-600 rounded w-24 mb-1 animate-pulse" />
              <div className="h-6 sm:h-8 bg-blue-300 dark:bg-blue-600 rounded w-12 mb-1 animate-pulse" />
              <div className="h-2 sm:h-2.5 bg-blue-300 dark:bg-blue-600 rounded w-24 animate-pulse" />
            </div>
            <div className="shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-blue-500/40 dark:bg-blue-700/40" />
          </div>
      ...
      <div className="space-y-6 mt-8">
        {/* Section Header */}
        <div>
          <div className="h-7 sm:h-8 bg-linear-to-r from-slate-300 to-slate-200 dark:from-slate-600 dark:to-slate-700 rounded-lg w-80 max-w-full animate-pulse mb-2" />
          <div className="h-4 sm:h-5 bg-linear-to-r from-slate-200 to-slate-100 dark:from-slate-700 dark:to-slate-800 rounded-lg w-full max-w-2xl animate-pulse" />
        </div>

        {/* Behavior Event Cards */}
