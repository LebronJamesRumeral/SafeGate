      ...
      <div className="space-y-6 animate-fade-in-up px-2 sm:px-0">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-5">
          ...
          <Card className="border-0 bg-linear-to-br from-sky-50 to-white dark:from-sky-950/30 dark:to-slate-800/80 shadow-lg overflow-hidden relative group hover:shadow-xl transition-all duration-300">
            <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-sky-500/15 dark:bg-sky-400/10 rounded-full -mr-6 sm:-mr-8 -mt-6 sm:-mt-8 group-hover:scale-125 transition-transform duration-500" />
            <CardContent className="p-2 sm:p-3 md:p-4 flex items-start justify-between relative z-10 gap-1.5 sm:gap-2">
              <div className="flex-1 min-w-0">
                <p className="text-[8px] sm:text-[9px] md:text-[10px] text-sky-600 dark:text-sky-400 font-semibold mb-0.5 uppercase tracking-wide leading-tight">Children Linked</p>
                <div className="text-base sm:text-lg md:text-2xl font-bold text-sky-600 dark:text-sky-400 leading-tight">{children.length}</div>
                <p className="text-[7px] sm:text-[8px] md:text-[9px] text-slate-500 dark:text-slate-400 mt-0.5 leading-tight">Total children linked</p>
              </div>
              <div className="hidden md:flex shrink-0 w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-linear-to-br from-sky-500 to-sky-600 text-white items-center justify-center shadow-md shadow-sky-500/20 dark:shadow-sky-500/10 group-hover:scale-105 transition-all duration-300">
          ...
          <Card className="border-0 bg-linear-to-br from-orange-50 to-white dark:from-orange-950/30 dark:to-slate-800/80 shadow-lg overflow-hidden relative group hover:shadow-xl transition-all duration-300">
            ...
            <CardContent className="p-2 sm:p-3 md:p-4 flex items-start justify-between relative z-10 gap-1.5 sm:gap-2">
              <div className="flex-1 min-w-0">
                <p className="text-[8px] sm:text-[9px] md:text-[10px] text-orange-600 dark:text-orange-400 font-semibold mb-0.5 uppercase tracking-wide leading-tight">Behavioral Events</p>
                <div className="text-base sm:text-lg md:text-2xl font-bold text-orange-600 dark:text-orange-400 leading-tight">{
                  Object.values(behavioralEvents).reduce((acc: number, events: any) => acc + (Array.isArray(events) ? events.length : 0), 0)
                }</div>
                <p className="text-[7px] sm:text-[8px] md:text-[9px] text-slate-500 dark:text-slate-400 mt-0.5 leading-tight">Total behavioral events</p>
              </div>
          ...
          >
            <div className="space-y-3 sm:space-y-6">
              <div className="flex flex-row items-center gap-2 sm:gap-4">
                <div className="p-2 sm:p-3 rounded-2xl bg-linear-to-br from-blue-900 to-blue-700 shadow-lg shadow-blue-600/25">
                  <Brain className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                </div>
                <div className="flex-1 min-w-0">
                  <h2 className="text-xl sm:text-3xl font-bold bg-linear-to-r from-blue-900 to-blue-700 bg-clip-text text-transparent mb-1 sm:mb-2">
                    ML Behavior Risk Insights
                  </h2>
                  <p className="text-xs sm:text-base text-slate-600 dark:text-slate-400 leading-snug sm:leading-normal">
