          ...
          <div className="mb-6 lg:mb-8">
            ...
            <div className="space-y-1.5 lg:space-y-2">
              ...
              <div className="relative">
                <Mail className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500 dark:text-slate-300" />
                <Input
                  id="email"
                  type="email"
            ...
            <div className="space-y-1.5 lg:space-y-2">
              ...
              <div className="relative">
                <Lock className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500 dark:text-slate-300" />
                <Input
                  id="password"
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-600 dark:text-slate-300 hover:text-sky-600 dark:hover:text-white rounded focus:outline-none focus:ring-2 focus:ring-sky-400 transition-transform duration-200"
                  style={{
